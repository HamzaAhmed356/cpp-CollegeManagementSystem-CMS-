...
This project demonstrates the use of **Object-Oriented Programming (OOP)** concepts, **file handling**, and **Windows console features**.
...
- Allow students and teachers to access their portals
- Use files to permanently store data
...
| `StudentFile.txt` | Stores student records |
| `TeacherFile.txt` | Stores teacher records |
| `JobTeacherFile.txt` | Stores teacher job applications |
...
5. Make sure you are using **Windows OS** (required for `windows.h`)
